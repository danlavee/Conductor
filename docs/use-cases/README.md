...
- [Establish shared working agreements](establish-shared-working-agreements.md)
- [Read shared work](read-shared-work-and-catch-up.md)
- [Publish a coordinated change](publish-one-coordinated-change.md)
- [Wait for team activity](wait-for-team-activity.md)
- [Handle contention and interrupted work](handle-contention-and-interrupted-work.md)
